...
public class TextMeshCreator {
	...
	private TextMeshData createQuadVertices(GUIText text, List<Line> lines) {
		...
		double curserX = (double)position.x / Display.getWidth();
		double curserY = (double)position.y / Display.getHeight();
		...
		for (Line line : lines) {
			...
			curserX = 0;
			curserY += LINE_HEIGHT * text.getFontSize() + text.getPosition().y;
		}		
