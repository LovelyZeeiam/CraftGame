...
public class LiveRecorder {
	...
	public static void main(String[] args) throws Exception {
		...
		int roomID = Integer.parseInt(
			Files.readAllString(new File("res/text/roomid.txt"))
		);
		...
		{
			URL url = new URL("https://api.live.bilibili.com/xlive/web-room/v1/index/getDanmuInfo?type=0&;id=" + roomID);
		...
		danmakuServerHeaderHashMap.put("User-Agent", "Mozilla/5.0 (X11; Linux x86_64; rv:84.0) Gecko/20100101 Firefox/84.0");
		danmakuServerHeaderHashMap.put("Accept", "*/*");
		danmakuServerHeaderHashMap.put("Accept-Language", "zh-CN,zh;q=0.8,zh-TW;q=0.7,zh-HK;q=0.5,en-US;q=0.3,en;q=0.2");
