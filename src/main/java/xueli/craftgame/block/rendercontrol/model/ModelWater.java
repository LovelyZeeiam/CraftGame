...
public class ModelWater extends IModel {
	...
	public int getRenderCubeData(FloatList buffer, BlockData data, int x, int y, int z, byte face,
		...
		case BlockFace.FRONT:
			if (world != null && world.hasBlock(new Vector3i(x, y, z - 1))
					&& world.getBlock(x, y, z - 1).getData().getNamespace().equals(data.getNamespace()))
				break;
		...
		case BlockFace.RIGHT:
			if (world != null && world.hasBlock(new Vector3i(x + 1, y, z))
					&& world.getBlock(x + 1, y, z).getData().getNamespace().equals(data.getNamespace()))
				break;
			buffer.put(u1).put(v2);
			buffer.put(0.7f * r).put(0.7f * g).put(0.7f * b);
			buffer.put(x + 1).put(y).put(z);
		...
		case BlockFace.LEFT:
			...
			break;
		case BlockFace.TOP:
			if (world != null && world.hasBlock(new Vector3i(x, y + 1, z))
					&& world.getBlock(x, y + 1, z).getData().getNamespace().equals(data.getNamespace()))
				break;
			buffer.put(u1).put(v2);
