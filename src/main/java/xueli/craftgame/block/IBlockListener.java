...
public interface IBlockListener extends IItemListener {
	...
	public static IBlockListener EMPTY = new IBlockListener() {
		@Override
		public void onLookAt(int x, int y, int z, BlockBase tile, Dimension world, Player player) {
		}

		@Override
		public void onPlaced(int x, int y, int z, BlockBase tile, Dimension world, Player player) {
		}

		@Override
		public void onLeftClick(int x, int y, int z, BlockBase tile, Dimension world, Player player) {
		}

		@Override
		public void onRightClick(int x, int y, int z, BlockBase tile, Dimension world, Player player) {
		}
