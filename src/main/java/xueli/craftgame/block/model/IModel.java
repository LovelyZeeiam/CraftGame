...
public abstract class IModel {
	...
	public abstract int getRenderData(FloatList buffer, int x, int y, int z, byte face, long details, BlockData data,
			TextureAtlas blockTextureAtlas, World world);

	public boolean isAlpha(int x, int y, int z, World world) {
		return false;
	}

	public boolean isCompleteBlock(int x, int y, int z, World world) {
		return true;
	}
