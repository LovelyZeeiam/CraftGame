...
public class BlockMessageView extends InGameView {
	...
	public BlockMessageView(Tile tile, WorldLogic logic) {
		...
		this.message_title = game.getLangManager().getStringFromLangMap("#hud.ingame.block_message.title")
				+ tile.getData().getBlockName();
	...
	public void draw(long nvg) {
		...
		nvgTextBox(nvg, content_x, content_y + scroll_offset, realSizeWidth - padding * 2 * display.getScale(),
				tile.getParams().message);
