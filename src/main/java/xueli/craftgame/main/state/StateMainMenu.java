package xueli.craftgame.main.state;
...
import xueli.utils.EvalableFloat;
...
public class StateMainMenu extends NVGRenderer {
	...
	public StateMainMenu() {
		...
		this.tex_back = nvgCreateImage(nvg, ModCraftGame.MAIN_GAME.getResFolder() + "/gui/options_background.png",
				NVG_IMAGE_REPEATX | NVG_IMAGE_REPEATY | NVG_IMAGE_NEAREST);
		this.tex_single = nvgCreateImage(nvg,
				ModCraftGame.MAIN_GAME.getResFolder() + "/gui/main_menu/single_player.png", NVG_IMAGE_GENERATE_MIPMAPS);
		this.tex_multi = nvgCreateImage(nvg, ModCraftGame.MAIN_GAME.getResFolder() + "/gui/main_menu/multi_player.png",
				NVG_IMAGE_GENERATE_MIPMAPS);
		this.tex_setting = nvgCreateImage(nvg, ModCraftGame.MAIN_GAME.getResFolder() + "/gui/main_menu/settings.png",
				NVG_IMAGE_GENERATE_MIPMAPS);
		this.tex_logo = nvgCreateImage(nvg, ModCraftGame.MAIN_GAME.getResFolder() + "/gui/CraftGame.png",
				NVG_IMAGE_GENERATE_MIPMAPS);
	...
	public void stroke() {
		// background
		{
			nvgImagePattern(nvg, 0, 0, game.getWidth(), game.getHeight(), 0, tex_back, 1, paint);
			nvgBeginPath(nvg);
