...
public class StateSplash extends NVGRenderer {
	...
	public StateSplash() {
		super();
		this.cg = (CraftGame) game;

		nvgCreateFont(nvg, fontName, ModCraftGame.MAIN_GAME.getResFolder() + "/fonts/Minecraft-Ascii.ttf");
		this.tex_splash = nvgCreateImage(nvg, ModCraftGame.MAIN_GAME.getResFolder() + "/gui/splash.jpg",
	...
	public void stroke() {
		...
		if (cg.initComplete) {
			game.getManager().setCurrentRenderer(new StateMainMenu());
		}
