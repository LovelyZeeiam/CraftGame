...
public class CameraThirdPersonBack implements CameraState {
	...
	public Vector getCameraViewMatrix(Player player) {
		...
		return new Vector(rayEndVector3f.x, rayEndVector3f.y, rayEndVector3f.z, rotX, rotY, rotZ);
	}
