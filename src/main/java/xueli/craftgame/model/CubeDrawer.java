...
public class CubeDrawer {
	...
	public static int drawQuadFacingBottom(WrappedFloatBuffer buffer, Vector3f v1, Vector2f u1, Vector4f c1, Vector3f v2,
			Vector2f u2, Vector4f c2, Vector3f v3, Vector2f u3, Vector4f c3, Vector3f v4, Vector2f u4, Vector4f c4) {
		// 1,2,3,2,4,3
		buffer.put(v1).put(u1).put(c1);
		buffer.put(v2).put(u2).put(c2);
	...
	public static int drawQuad(WrappedFloatBuffer buffer, Vector3f n, Vector3f v1, Vector2f u1, Vector4f c1, Vector3f v2,
			Vector2f u2, Vector4f c2, Vector3f v3, Vector2f u3, Vector4f c3, Vector3f v4, Vector2f u4, Vector4f c4) {
		// 1,2,3,2,4,3
		buffer.put(v1).put(u1).put(c1);
		buffer.put(v2).put(u2).put(c2);
	...
	public static int drawQuad(WrappedFloatBuffer buffer, byte face, Vector3f n, Vector3f v1, Vector2f u1, Vector4f c1, Vector3f v2,
			Vector2f u2, Vector4f c2, Vector3f v3, Vector2f u3, Vector4f c3, Vector3f v4, Vector2f u4, Vector4f c4) {
		int vertCount = 6;
		switch (face) {
