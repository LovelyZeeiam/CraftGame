...
public class RendererCube extends IBlockRenderer {
	...
	public RendererCube(WorldRenderer manager) {
		...
		try {
			setShader(
					new String(Files.readResourcePackedInJar("/assets/craftgame/shaders/world/world.vert"),
							StandardCharsets.UTF_8),
					new String(Files.readResourcePackedInJar("/assets/craftgame/shaders/world/world.frag"),
							StandardCharsets.UTF_8));
		} catch (Exception e) {
