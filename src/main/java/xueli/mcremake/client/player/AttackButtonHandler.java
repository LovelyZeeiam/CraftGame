...
public class AttackButtonHandler extends FunctionalKeyHandler {
	...
	protected void functionContinue(CraftGameClient ctx) {
		// TODO: In creative mode, when the player is faster, its break cooldown should
		// be faster. So is it when placing blocks.
		// TODO: When we can aim at an entity, the block break cooldown should not be
		// updated.
