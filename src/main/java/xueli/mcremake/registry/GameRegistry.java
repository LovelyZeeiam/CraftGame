...
//	public static final BlockType BLOCK_SAND_STONE;
	...
	static {
		...
		BLOCK_STONE = registerBlockType(writable, new ResourceIdentifier("stone"), "Stone",
				new BlockRendererSolid(1, 0), new BlockCollidableSolid(), TAG_GENERIC_BLOCK);
		BLOCK_DIRT = registerBlockType(writable, new ResourceIdentifier("dirt"), "dirt", new BlockRendererSolid(2, 0),
				new BlockCollidableSolid(), TAG_GENERIC_BLOCK);
		BLOCK_GRASS = registerBlockType(writable, new ResourceIdentifier("grass_block"), "Grass Block",
				new BlockRendererSideTopBottom(3, 0, 1, 7, 2, 0), new BlockCollidableSolid(), TAG_GENERIC_BLOCK);
		BLOCK_BEDROCK = registerBlockType(writable, new ResourceIdentifier("bedrock"), "bedrock",
				new BlockRendererSolid(1, 1), new BlockCollidableSolid(), TAG_GENERIC_BLOCK);
		BLOCK_SAND = registerBlockType(writable, new ResourceIdentifier("sand"), "sand", new BlockRendererSolid(2, 1),
				new BlockCollidableSolid(), TAG_GENERIC_BLOCK);
		BLOCK_GRAVEL = registerBlockType(writable, new ResourceIdentifier("gravel"), "gravel",
				new BlockRendererSolid(3, 1), new BlockCollidableSolid(), TAG_GENERIC_BLOCK);
		BLOCK_WATER = registerBlockType(writable, new ResourceIdentifier("water"), "water",
	...
	static {
		...
		BIOME_SEASONAL_FOREST = registerBiomeType(writable, new ResourceIdentifier("seasonal_forest"),
		...
		BIOME_ICE_DESERT = registerBiomeType(writable, new ResourceIdentifier("ice_desert"), "Ice Desert"); // But
																											// inside
																											// the game
																											// it seems
																											// to extend
	...
	public static BlockType registerBlockType(WritableRegistry<BlockType> registry, ResourceIdentifier identify,
			String name, BlockVertexGatherer renderer, BlockCollidable collidable, ResourceIdentifier... tags) {
	...
	private static ItemType registerItemFromBlock(WritableRegistry<ItemType> registry,
			WritableRegistry<ResourceIdentifier> itemBlockMapRegistry, BlockType block, ItemVertexGatherer renderer,
	...
	public static ItemType registerItemType(WritableRegistry<ItemType> registry, ResourceIdentifier identify,
			String name, ItemVertexGatherer renderer, ResourceIdentifier... tags) {
	...
	private static BiomeType registerBiomeType(WritableRegistry<BiomeType> registry, ResourceIdentifier identify,
			String name, ResourceIdentifier... tags) {
