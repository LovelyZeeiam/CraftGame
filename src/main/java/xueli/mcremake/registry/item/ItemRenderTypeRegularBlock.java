...
public class ItemRenderTypeRegularBlock implements ItemRenderType {
	...
	public void renderUI(BlockType block, CompoundMap tags, float x, float y, float width, float height, NanoGui gui) {
...
//		System.out.println(image);
	...
	@Override
	public void reload() {
		// When reload GUI class will recreate NanoVG instance when our registered image
		// gets deleted
