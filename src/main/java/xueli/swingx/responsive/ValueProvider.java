...
public interface ValueProvider<T, K> {
	...
	public static ValueProvider<Dimension, Dimension> newProviderRatioHeight(
			ValueProvider<Integer, Integer> heightProvider, double ratio) {
		return d -> {
	...
	// The ratio should be the result of width / height
	public static ValueProvider<Dimension, Dimension> newProviderRatioWidth(
			ValueProvider<Integer, Integer> widthProvider, double ratio) {
		return d -> {
	...
	// The ratio should be the result of width / height
	public static ValueProvider<Dimension, Dimension> newProviderRatioVMin(ValueProvider<Integer, Integer> minProvider,
			double ratio) {
		return d -> {
	...
	// The ratio should be the result of width / height
	public static ValueProvider<Dimension, Dimension> newProviderRatioVMax(ValueProvider<Integer, Integer> maxProvider,
			double ratio) {
		return d -> {
			int childWidth, childHeight;
			if (d.width <= d.height) {
