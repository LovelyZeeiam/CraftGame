...
/**
 * The aim to write this listener is to make use of the "layoutContainer"
 * method, because when the father's "layoutContainer" is called, its size is
 * adjusted, but all of its children's size is not calculated. So to make
 * responsive layout we can slide in this golden opportunity.
 */
