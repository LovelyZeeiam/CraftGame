...
public interface ECSContext {
	...
	/**
	 * Add a resource.
	 * A resource is a component that isn't bound to any entity and only one instance of each type exists.
	 ...
	 * Get a resource.
	 * @param <R> The type of the resource
	 * @return The unique resource instance in the type R, or null if we don't have the corresponding resource.
	 */
	...
	/**
	 * Broadcast an event to the context.
	 * When next update occurs, every system should have access to the events.
	 * And when it is the following update, these events will become inaccessible.
	 ...
	 * Read an event
	 * @param <E> The type of the event
	 * @return The instance of the event, or null if there is no event belonging to type E now
	 */
