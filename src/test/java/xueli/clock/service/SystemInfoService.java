...
//
//	private static final String sysInfoStr = osInfoBean.getFamily().trim() + " "
//			+ osInfoBean.getVersionInfo().getVersion().trim();
...
//	private static final CentralProcessorLoadTicker cpuLoadBean = new CentralProcessorLoadTicker(
//			harderLayerBean.getProcessor());
//
...
//		bean.setMemoryInfo(memoryUsedPercentage,
//				String.format("%s / %s", FormatUtil.formatBytes(memoryUsed), FormatUtil.formatBytes(memoryTotal)));
//
...
//			bean.setPowerCharging(powerSourceBean.isCharging(), 100.0 * curCapacity / maxCapacity,
//					formatEfficiency(powerSourceBean.getPowerUsageRate() / 1000));
//
//		}
//
	}
