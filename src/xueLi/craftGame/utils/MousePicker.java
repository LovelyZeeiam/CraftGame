...
public class MousePicker {
	...
	public static void ray(Vector pos) {
		...
		//Vector2f normalizedMouseCoords = new Vector2f((2f * (MouseX)) / Display.getWidth() - 1f,(2f * (MouseY)) / Display.getHeight() - 1f);
	...
	public static BlockPos getPointOnRay(float distance) {
		...
		return new BlockPos(GLHelper.floatToInt(rayEnd.x),GLHelper.floatToInt(rayEnd.y),GLHelper.floatToInt(rayEnd.z));
	}
